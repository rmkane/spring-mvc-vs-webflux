package org.acme.security.webflux.listener;
...
/**
 * WebFlux: logs security header / header-logging policy at startup.
 */
@Component
public class WebFluxSecurityStartupListener extends AbstractAcmeSecurityStartupListener {

    private final AcmeHeaderLoggingPolicy headerLoggingPolicy;

    public WebFluxSecurityStartupListener(
