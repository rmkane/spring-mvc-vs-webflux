...
This directory contains keystores and truststores for the API MVC service.
...
- `api-mvc-keystore.jks` - Server keystore containing the service certificate and private key
