...
This directory contains keystores and truststores for the API WebFlux service.
...
- `api-webflux-keystore.jks` - Server keystore containing the service certificate and private key
